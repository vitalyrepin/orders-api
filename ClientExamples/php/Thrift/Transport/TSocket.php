...
class TSocket extends TTransport {
  ...
  public function read($len) {
    ...
    if ($readable > 0) {
      ...
      // This line tryes to read UNENCRYPTED buffer from the network.  I can't get any idea why. fread works perfectly.
  ...
  public function write($buf) {
	...
	// This line writes to the network UNENCRYPTED buffer.  I can't get any idea why. fwrite works perfectly.
